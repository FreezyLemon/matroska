...
impl_ebml_master! {
    ...
    #[derive(Debug, Default, Clone, PartialEq)]
    struct Chapters {
        [0x45B9] edition_entry: (Vec<EditionEntry>) [1..],
    }
}
...
impl_ebml_master! {
    ...
    struct EditionEntry {
        ...
        [0x45DB] flag_default: (u64) = 0,
        [0x45DD] flag_ordered: (u64) = 0,
        // FIXME: Handle recursive Elements like ChapterAtom correctly
...
impl_ebml_master! {
    ...
    struct ChapterDisplay {
        [0x85] string: (String),
        [0x437C] language: (Vec<String>) [1..],
        [0x437D] language_bcp47: (Vec<String>) [0..],
        [0x437E] country: (Vec<String>) [0..],
    }
}
...
impl_ebml_master! {
    ...
    struct ChapterProcess {
        ...
        [0x6911] command: (Vec<ChapterProcessCommand>) [0..],
    }
}
